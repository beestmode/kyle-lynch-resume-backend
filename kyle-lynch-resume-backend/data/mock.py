# Mock data for Kyle Lynch Resume - Backend copy for database initialization
resumeData = {
  "personalInfo": {
    "name": "Kyle J. Lynch",
  ...
  "education": [
    ...
    {
      "id": "3",
      "degree": "Control and Instrumentation Engineering Technology",
      "institution": "UH Downtown",
      "location": "Houston, TX", 
      "duration": "1/16 – 5/16"
    },
    {
      ...
      "location": "Central Houston, Sugar Land, TX",
      "duration": "9/16 – 5/19"
    },
    {
      "id": "5",
      "degree": "HIPAA Awareness for Couriers",
      "institution": "Integrity Medical Courier Training",
      "location": "integritydelivers.com",
      "duration": "9/24 – 9/25"
    },
    {
      "id": "6",
      "degree": "Bloodborne Pathogen Exposure Control",
      "institution": "Integrity Medical Courier Training",
      "location": "",
      "duration": "9/24 – 9/25"
    }
